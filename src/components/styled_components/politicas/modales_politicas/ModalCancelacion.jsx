...
import data from './textos_politicas/cancelacionTexto.json'
import Cancelacion from "./textos_politicas/Cancelacion";

const ModalCancelacion = ({showModal, setShowModal}) => {
    ...
    <>
        ...
        <Background ref={modalRef} onClick={closeModal}>
            <ModalWrapper showModal={showModal}>
                <ModalContent>
                    <Cancelacion titulo={data.titulo} contenido={data.contenido}/>
                </ModalContent>
