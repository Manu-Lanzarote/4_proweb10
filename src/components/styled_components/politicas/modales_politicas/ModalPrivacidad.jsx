...
import data from './textos_politicas/privacidadTexto.json'
import Privacidad from "./textos_politicas/Privacidad";

const ModalPrivacidad = ({showModal, setShowModal}) => {
    ...
    <>
        ...
        <Background ref={modalRef} onClick={closeModal}>
            <ModalWrapper showModal={showModal}>
                <ModalContent>
                    <Privacidad titulo={data.titulo} contenido={data.contenido}/>
                </ModalContent>
