...
import data from './textos_politicas/cookiesTexto.json'
import Cookies from "./textos_politicas/Cookies";

const ModalCookies = ({showModal, setShowModal}) => {
    ...
    <>
        ...
        <Background ref={modalRef} onClick={closeModal}>
            <ModalWrapper showModal={showModal}>
                <ModalContent>
                    <Cookies titulo={data.titulo} contenido={data.contenido}/>
                </ModalContent>
